...
class Personnage:
    ...
    def afficheCarac(self):
        print(" °~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~°" )
        print(" %s \n \t FORCE : %i \n \t ENDURANCE: %i \n  \t RAPIDITE: %i \n \t INTELLIGENCE: %i \n "%(self.nom , self.force, self.endurance, self.rapidite, self.intelligence))
        print("°~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~°")
...
#nom, race, classe, pv, pvMax, force, endurance, rapidite, intelligence
nom = ["Sylvanas", "Gazleu", "Léoric", "Cairne", "Tyrande", "Milhouse", "Varyan", "Dagran"]
classe = ["guerrier", "archer", "mage"]
...
# liste de personnages ajout attibut  camp gentil et mechant ajout ID (import randint et uniform)
...
"""   if (choixCamp == "alliance"):
        personnageAlliance.append(nom, race, pv, pvMax, force, endurance, rapidite, intelligence)
    else:
"""
